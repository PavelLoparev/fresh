...
impl JsEditorApi {
    ...
    #[plugin_api(js_name = "moveTabLeft", ts_return = "boolean")]
    pub fn move_tab_left(&self) -> bool {
    ...
    #[plugin_api(js_name = "moveTabRight", ts_return = "boolean")]
    pub fn move_tab_right(&self) -> bool {
        self.command_sender
